...
$query2="SELECT DISTINCT artisans.artisan_id,artisans.companyname,artisans.description,
artisans.tradetype,artisans.city,artisans.avatar FROM artisans INNER JOIN client_reviews ON artisans.artisan_id=client_reviews.artisan_user_id WHERE artisans.tradetype='".$data1["tradetype"]."'";
