<?php
   ...
   clients.jobaddress,clients.jobcountry,jobs_requests.artisan_user_id FROM clients INNER JOIN jobs_requests ON clients.job_id = jobs_requests.job_id WHERE jobs_requests.artisan_user_id='".$artisanId."' ORDER BY clients.id DESC";
